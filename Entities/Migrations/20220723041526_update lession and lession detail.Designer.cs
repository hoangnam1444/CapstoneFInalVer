...
namespace Entities.Migrations
{
    ...
    [Migration("20220723041526_update lession and lession detail")]
    partial class updatelessionandlessiondetail
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Models.CollegesSubjectGroup", b =>
                {
                    ...
                    b.HasKey("CollegesId", "SubjectGroupId");

                    b.HasIndex("MajorId");

                    b.HasIndex("SubjectGroupId");

                    b.ToTable("Colleges_SubjectGroup");
                });
            ...
            modelBuilder.Entity("Entities.Models.UserMajor", b =>
                {
                    b.Property<int>("MajorId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.Models.RecommentLession", b =>
                {
                    b.HasOne("Entities.Models.LessionDetails", "LessionDetail")
                        .WithOne("Lession")
                        .HasForeignKey("Entities.Models.RecommentLession", "LessionDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
